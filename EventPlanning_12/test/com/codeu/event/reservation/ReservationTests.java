...
public class ReservationTests {
	...
	public final void testValidateClubNumber() {
		...
		assertTrue(Reservation.validateClubNumber(cnOne));
		assertFalse(Reservation.validateClubNumber(cnTwo));
	}
	...
	public final void testValidateLicense() {
		...
		assertTrue(Reservation.validateLicense(dlOne));
		assertFalse(Reservation.validateLicense(dlTwo));
	}
