...
//	End dirty data.
	private Rental room = new HotelRoom(1214, 2, false);
	private Rental car = new RentalCar(2014, "Fire", "Hide", 45, as.getFirstName(), as.getLastName());
	
	private Reservation roomRes = new RoomReservation(ak, room, false);
	private Reservation carRes = new CarReservation(as, car);
