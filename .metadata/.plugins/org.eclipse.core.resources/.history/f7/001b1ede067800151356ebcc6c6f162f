...
//	Tests for all Calculator methods.
	...
	public void testSumArray() {
		...
		String arrString2[] = {"10", "wicked", "30", "mmmmm", "8789"};
	...
	public void testCountValues() {
		...
		assertEquals(3, calc.countValues(arrInt, 60), .001);
		assertEquals(2, calc.countValues(arrDouble, 78.5), .001);
		assertEquals(3, calc.countValues(arrString, 87), .001);
		assertEquals(0, calc.countValues(arrStringCheck, 1), .001);
	}
