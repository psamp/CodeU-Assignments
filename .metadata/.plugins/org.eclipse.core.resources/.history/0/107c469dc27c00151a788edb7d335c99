...
public class CarResTests {
	...
	private Reservation resOne;
	private Reservation resTwo;
	...
	private Rentable carOne = new RentalCar(2015, "GMC", "Yukon", 3, guestOne.getFirstName(), guestOne.getLastName());
	private Rentable carTwo = new RentalCar(2009, "Honda", "Accord", 6, guestTwo.getFirstName(), guestTwo.getLastName());

	@Before
	public void setUp() {

		resOne = new CarReservation(guestOne, carOne);
