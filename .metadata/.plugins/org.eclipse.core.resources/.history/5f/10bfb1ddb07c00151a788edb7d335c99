...
public class CarResTests {
	...
	private Rental carOne = new RentalCar(2015, "GMC", "Yukon", 3, guestOne.getFirstName(), guestOne.getLastName());
	private Rental carTwo = new RentalCar(2009, "Honda", "Accord", 6, guestTwo.getFirstName(), guestTwo.getLastName());
