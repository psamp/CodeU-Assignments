...
public class RentalManager {
	...
	public String displayAllHotelRooms() {
		
		String mssg = report.toStringAllRooms(RentalManager.rooms);
		return mssg;
		
	}
	
	public String displayAllRentalCars() {
		String mssg = report.toStringAllCars(RentalManager.cars);
		return mssg;
	}
