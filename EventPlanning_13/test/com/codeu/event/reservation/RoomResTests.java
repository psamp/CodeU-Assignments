...
public class RoomResTests {
	...
	public final void testValidateClubNumber() {
		boolean actualOne = Reservation.validateClubNumber(guestMatt.getHotelClubNumber());
		boolean actualTwo = Reservation.validateClubNumber(guestFoggy.getHotelClubNumber());
